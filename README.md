...
# Buat tabel analisa 
Pada proyek ini, diminta untuk membuat table analisa berdasarkan hasil aggregasi dari ke-empat table yang sudah diimport sebelumnya. Berikut ini adalah kolom-kolom yang mandatory pada tabel tersebut: 
